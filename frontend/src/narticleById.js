...
try{
    ...
    leftCard.innerHTML = `<img class="card-img mb-3" src="https://images.unsplash.com/photo-1529534571712-fad9a49b5ee9?q=80&w=3870&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D">
                            ...
                            <p class="card-text"> <span style="margin:0; padding:0; font-size:80px; color:red; font-weight:900;">${article?.description[0].toUpperCase()} </span>${article?.description.slice(1, article?.description.length)}</p>
    ...
    rightCard.innerHTML = `<h3 class="card-title h5 mb-3 text-">Article Information</h3>
